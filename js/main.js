...
import { S, initDMMaps } from './state.js?v=10';
import { SUPPLEMENTS, CAT, QUARTERS } from './data.js?v=10';
import {
...
import * as panelFns from './panels.js?v=10';
import * as supaFns from './supabase.js?v=10';
import * as stateModule from './state.js?v=10';
